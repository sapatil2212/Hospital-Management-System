    ...
    <div style={{ maxWidth: 700, margin: "0 auto" }}>
        ...
        <div style={{ display: "flex", alignItems: "center", gap: 16 }}>
          <div
            ...
            style={{
              ...
              position: "relative", boxShadow: "0 4px 12px rgba(14,137,143,0.25)",
          ...
          <div>
            <h2 style={{ fontSize: 18, fontWeight: 700, color: "#1e293b" }}>{u?.name}</h2>
            <p style={{ fontSize: 13, color: "#64748b", marginTop: 2 }}>{u?.email}</p>
            <p style={{ fontSize: 11, color: "#94a3b8", marginTop: 4 }}>{uploading ? "Uploading photo..." : "Click avatar to upload photo"}</p>
          ...
          <div style={{ display: "grid", gap: 16 }}>
            <div>
              ...
              <div style={{ position: "relative" }}>
                ...
                <input type="text" value={formData.name} onChange={(e) => setFormData({ ...formData, name: e.target.value })} style={{ width: "100%", padding: "10px 10px 10px 40px", borderRadius: 8, border: "1.5px solid #e2e8f0", fontSize: 13, color: "#1e293b", outline: "none", boxSizing: "border-box" }} placeholder="Enter your full name" required />
              </div>
            </div>
            <div>
              ...
              <div style={{ position: "relative" }}>
                ...
                <input type="email" value={formData.email} onChange={(e) => setFormData({ ...formData, email: e.target.value })} style={{ width: "100%", padding: "10px 10px 10px 40px", borderRadius: 8, border: "1.5px solid #e2e8f0", fontSize: 13, color: "#1e293b", outline: "none", boxSizing: "border-box" }} placeholder="Enter your email address" required />
              </div>
            </div>
          </div>
          <div style={{ marginTop: 20 }}>
            <button type="submit" disabled={saving} style={{ padding: "10px 24px", borderRadius: 8, border: "none", background: "#0E898F", color: "#fff", fontSize: 13, fontWeight: 600, cursor: saving ? "not-allowed" : "pointer", opacity: saving ? 0.7 : 1, display: "flex", alignItems: "center", gap: 8, boxShadow: "0 4px 12px rgba(14,137,143,0.25)" }}>
      ...
      <div style={{ background: "#fff", borderRadius: 16, border: "1px solid #e2e8f0", boxShadow: "0 1px 4px rgba(0,0,0,0.04)", padding: 28, marginTop: 20 }}>
        <h3 style={{ fontSize: 15, fontWeight: 700, color: "#1e293b", marginBottom: 4, display: "flex", alignItems: "center", gap: 8 }}>
          <Key size={16} color="#0E898F" />Change Password
        </h3>
        ...
        <form onSubmit={handleChangePassword}>
          <div style={{ display: "grid", gap: 14 }}>
            <div>
              ...
              <div style={{ position: "relative" }}>
                ...
                <input type={cpShowOld ? "text" : "password"} value={cpOld} onChange={(e) => setCpOld(e.target.value)} placeholder="Enter current password" style={{ width: "100%", padding: "10px 40px 10px 38px", borderRadius: 8, border: "1.5px solid #e2e8f0", fontSize: 13, color: "#1e293b", outline: "none", boxSizing: "border-box" }} />
            ...
            <div>
              ...
              <div style={{ position: "relative" }}>
                <Lock size={15} color="#94a3b8" style={{ position: "absolute", left: 12, top: "50%", transform: "translateY(-50%)" }} />
                <input type={cpShowNew ? "text" : "password"} value={cpNew} onChange={(e) => setCpNew(e.target.value)} placeholder="Choose a strong password" style={{ width: "100%", padding: "10px 40px 10px 38px", borderRadius: 8, border: "1.5px solid #e2e8f0", fontSize: 13, color: "#1e293b", outline: "none", boxSizing: "border-box" }} />
            ...
            <div>
              ...
              <div style={{ position: "relative" }}>
                <Lock size={15} color="#94a3b8" style={{ position: "absolute", left: 12, top: "50%", transform: "translateY(-50%)" }} />
                <input type={cpShowConfirm ? "text" : "password"} value={cpConfirm} onChange={(e) => setCpConfirm(e.target.value)} placeholder="Repeat your new password" style={{ width: "100%", padding: "10px 40px 10px 38px", borderRadius: 8, border: "1.5px solid #e2e8f0", fontSize: 13, color: "#1e293b", outline: "none", boxSizing: "border-box" }} />
          ...
          <div style={{ marginTop: 18 }}>
            <button type="submit" disabled={cpSaving} style={{ padding: "10px 24px", borderRadius: 8, border: "none", background: "#0E898F", color: "#fff", fontSize: 13, fontWeight: 600, cursor: cpSaving ? "not-allowed" : "pointer", opacity: cpSaving ? 0.7 : 1, display: "flex", alignItems: "center", gap: 8, boxShadow: "0 4px 12px rgba(14,137,143,0.25)" }}>
