...
export const metadata: Metadata = {
  title: "Privacy Policy | Celeb Aesthetica",
  description:
    "Learn how Celeb Aesthetica collects, uses, and protects your personal information. Our privacy policy outlines your rights and our commitments to data security.",
};
          ...
          <div className="container">
            <div className={styles.heroInner}>
              ...
              <p className={styles.heroSubtitle}>
                At Celeb Aesthetica, we are committed to protecting your personal
