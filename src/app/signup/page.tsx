          ...
          <div className="sp-form-box">
            ...
            {step === "form" && (
              <>
                ...
                <p className="sp-footer">Already registered? <Link href="/login">Sign In</Link> · <Link href="/" style={{display:"inline-flex",alignItems:"center",gap:4}}><svg width="12" height="12" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2.5" strokeLinecap="round" strokeLinejoin="round"><path d="M3 9l9-7 9 7v11a2 2 0 01-2 2H5a2 2 0 01-2-2z"/><polyline points="9 22 9 12 15 12 15 22"/></svg>Back to Home</Link></p>
              </>
            )}
