...
export const metadata: Metadata = {
  title: "Cookie Policy | Celeb Aesthetica",
  description:
    "Learn about how Celeb Aesthetica uses cookies and tracking technologies to improve your browsing experience and deliver personalized content.",
};
          ...
          <div className="container">
            <div className={styles.heroInner}>
              ...
              <p className={styles.heroSubtitle}>
                This Cookie Policy explains what cookies are, how Celeb Aesthetica uses them,
          ...
          <div className="container">
            <div className={styles.contentInner}>
              ...
              <div id="how-we-use" className={styles.section}>
                ...
                <p className={styles.sectionText}>
                  Celeb Aesthetica uses cookies for the following purposes:
                </p>
