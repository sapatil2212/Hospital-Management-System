        ...
        <div className={stateStyles.modalOverlay} onClick={() => setShowTerms(false)}>
          <div className={stateStyles.modalContent} onClick={(e) => e.stopPropagation()}>
            ...
            <div className={stateStyles.modalBody}>
              ...
              <p>By submitting this form, you consent to receive communication from Celeb Aesthetica regarding medical tourism packages, treatment options, and related services. Our team may contact you via phone, email, or WhatsApp based on your preferred contact method.</p>
              ...
              <p>By checking the consent checkbox and submitting this form, you authorize Celeb Aesthetica to contact you regarding your medical tourism inquiry. You may withdraw this consent at any time by contacting our support team.</p>
            </div>
