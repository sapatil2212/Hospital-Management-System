...
function Spinner() {
  return (
    <div style={{ minHeight: "100vh", background: "#f0f9f9", display: "flex", alignItems: "center", justifyContent: "center", fontFamily: "'Inter',sans-serif", gap: 14, color: "#64748b", fontSize: 14 }}>
    ...
    <>
      <style suppressHydrationWarning>{`
        ...
        *{box-sizing:border-box;margin:0;padding:0}
        ...
        .cl-av{width:32px;height:32px;border-radius:9px;background:linear-gradient(135deg,#0E898F,#6366f1);display:flex;align-items:center;justify-content:center;font-size:11px;font-weight:700;color:#fff;flex-shrink:0;overflow:hidden}
        .cl-uname{font-size:12px;font-weight:600;color:#1e293b;white-space:nowrap;overflow:hidden;text-overflow:ellipsis}
        ...
        .cl-profile-av{width:30px;height:30px;border-radius:8px;background:linear-gradient(135deg,#0E898F,#6366f1);display:flex;align-items:center;justify-content:center;font-size:11px;font-weight:700;color:#fff;overflow:hidden}
        ...
        .cl-dept-banner-name{font-size:20px;font-weight:800;letter-spacing:-.02em;position:relative}
        .cl-dept-banner-sub{font-size:12px;opacity:.75;margin-top:3px;position:relative}
        ...
        .cl-sc-val{font-size:22px;font-weight:800;color:#1e293b;letter-spacing:-.02em;line-height:1}
        ...
        .cl-card-title{font-size:13px;font-weight:700;color:#1e293b}
        ...
        .cl-tbl td{padding:12px 12px;font-size:12px;color:#475569;border-bottom:1px solid #f8fafc}
        ...
        /* ─── Section title ─── */
        .cl-section-title{font-size:13px;font-weight:700;color:#1e293b;margin-bottom:14px;display:flex;align-items:center;gap:8px}
        ...
        .cl-sd-name{font-size:13px;font-weight:700;color:#1e293b;overflow:hidden;text-overflow:ellipsis;white-space:nowrap}
        ...
        .cl-sd-stat-v{font-size:16px;font-weight:800}
