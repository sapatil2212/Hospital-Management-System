    ...
    <>
      <style suppressHydrationWarning>{`
        ...
        *{box-sizing:border-box;margin:0;padding:0}
        ...
        .hd-btn-primary{padding:8px 16px;border-radius:9px;border:none;background:#0E898F;color:#fff;font-size:11px;font-weight:700;cursor:pointer;display:flex;align-items:center;gap:6px;transition:all .15s;box-shadow:0 4px 12px rgba(14,137,143,0.25)}
        ...
        .hd-msubmit{flex:2;padding:10px;border-radius:9px;border:none;background:#0E898F;color:#fff;font-size:12px;font-weight:700;cursor:pointer;display:flex;align-items:center;justify-content:center;gap:6px;box-shadow:0 4px 12px rgba(14,137,143,0.25)}
                  ...
                  <>
                    ...
                    <div style={{
                      ...
                      <div style={{ padding: 16, borderBottom: "1px solid #f1f5f9" }}>
                        ...
                        {deptProfile && <div style={{ fontSize: 11, color: "#0E898F", marginTop: 4, fontWeight: 600 }}>{deptProfile.name} · {deptProfile.type}</div>}
                      </div>
                      <div style={{ padding: 8 }}>
                        <button
                          onClick={() => { setProfileDropdownOpen(false); logout(); }}
                          style={{ width: "100%", padding: "10px 12px", borderRadius: 8, border: "none", background: "transparent", color: "#ef4444", fontSize: 13, fontWeight: 500, cursor: "pointer", display: "flex", alignItems: "center", gap: 10 }}
