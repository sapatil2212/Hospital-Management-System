...
export const metadata: Metadata = {
  title: "Terms of Service | Celeb Aesthetica",
  description:
    "Read the Terms of Service for Celeb Aesthetica. Understand the terms and conditions that govern your use of our website and healthcare services.",
};
          ...
          <div className="container">
            <div className={styles.heroInner}>
              ...
              <p className={styles.heroSubtitle}>
                These Terms of Service govern your use of the Celeb Aesthetica website and
            ...
            <div className={styles.contentInner}>
              ...
              <div id="acceptance" className={styles.section}>
                ...
                <p className={styles.sectionText}>
                  By accessing or using the Celeb Aesthetica website, booking appointments, or
              ...
              <div id="services" className={styles.section}>
                ...
                <p className={styles.sectionText}>
                  Celeb Aesthetica provides a range of healthcare and aesthetic services including,
                  but not limited to:
                </p>
              ...
              <div id="appointments" className={styles.section}>
                ...
                <p className={styles.sectionText}>
                  When booking an appointment with Celeb Aesthetica, the following terms apply:
                </p>
                <ul className={styles.list}>
              ...
              <div id="intellectual-property" className={styles.section}>
                ...
                <p className={styles.sectionText}>
                  All content on the Celeb Aesthetica website, including but not limited to text,
                  graphics, logos, images, audio clips, digital downloads, and data compilations,
                  is the property of Celeb Aesthetica or its content suppliers and is protected by
                ...
                <ul className={styles.list}>
                  ...
                  <li className={styles.listItem}>The Celeb Aesthetica name, logo, and all related marks are trademarks of Celeb Aesthetica</li>
              ...
              <div id="limitation" className={styles.section}>
                ...
                <p className={styles.sectionText}>
                  To the fullest extent permitted by applicable law, Celeb Aesthetica shall not be
                ...
                <p className={styles.sectionText}>
                  ...
                  exceed the amount you paid to Celeb Aesthetica for the specific service giving rise
                  to the claim.
                </p>
              </div>
              ...
              <div id="indemnification" className={styles.section}>
                ...
                <p className={styles.sectionText}>
                  You agree to indemnify, defend, and hold harmless Celeb Aesthetica, its officers,
              ...
              <div id="contact" className={styles.section}>
                ...
                <ul className={styles.list}>
                  <li className={styles.listItem}><strong>Email:</strong>{" "}
                    <a href="mailto:celebaesthecia666@gmail.com" className={styles.contactLink}>
                      celebaesthecia666@gmail.com
                    </a>
                  </li>
