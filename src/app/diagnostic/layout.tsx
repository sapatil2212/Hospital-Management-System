    ...
    <>
      <style suppressHydrationWarning>{`
        ...
        *{box-sizing:border-box;margin:0;padding:0}
        ...
        .dg-wrap{display:flex;height:100vh;overflow:hidden;background:#fffdf5}
        ...
        .dg-topbar{height:64px;background:#fff;border-bottom:1px solid #e2e8f0;display:flex;align-items:center;justify-content:space-between;padding:0 24px;position:relative;z-index:40;flex-shrink:0;box-shadow:0 1px 6px rgba(217,119,6,.06)}
