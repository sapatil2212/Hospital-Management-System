...
import {
  ...
  ChevronDown, Search, Info, Stethoscope,
} from "lucide-react";
    ...
    <>
      <style suppressHydrationWarning>{`
        ...
        *{box-sizing:border-box;margin:0;padding:0}
        ...
        .dg-wrap{display:flex;min-height:100vh;background:#fffdf5}
        .dg-sb{width:224px;background:#fff;border-right:1px solid #e2e8f0;display:flex;flex-direction:column;position:fixed;left:0;top:0;bottom:0;z-index:50;box-shadow:2px 0 10px rgba(217,119,6,.06)}
        ...
        .dg-logo-ic{width:36px;height:36px;background:linear-gradient(135deg,${ACCENT},${ACCENT2});border-radius:10px;display:flex;align-items:center;justify-content:center;box-shadow:0 4px 12px rgba(217,119,6,.3);flex-shrink:0}
        .dg-logo-tx{font-size:14px;font-weight:800;color:#1e293b;letter-spacing:-.02em;line-height:1.2;white-space:nowrap;overflow:hidden;text-overflow:ellipsis}
        ...
        .dg-nb.on{background:linear-gradient(135deg,${ACCENT_LIGHT},#fef3c7);color:${ACCENT2};font-weight:700}
        ...
        .dg-main{margin-left:224px;flex:1;display:flex;flex-direction:column;min-height:100vh}
        .dg-topbar{height:64px;background:#fff;border-bottom:1px solid #e2e8f0;display:flex;align-items:center;justify-content:space-between;padding:0 24px;position:sticky;top:0;z-index:40;box-shadow:0 1px 6px rgba(217,119,6,.06)}
        ...
        .dg-search:focus-within{border-color:${ACCENT};box-shadow:0 0 0 3px rgba(217,119,6,.1)}
        ...
        .dg-profile-btn:hover{background:#fef3c7}
        .dg-profile-av{width:30px;height:30px;border-radius:8px;background:linear-gradient(135deg,${ACCENT},#ea580c);display:flex;align-items:center;justify-content:center;font-size:11px;font-weight:700;color:#fff;overflow:hidden}
        ...
        .dd-sc{background:#fff;border-radius:14px;padding:18px;border:1px solid #fef3c7;display:flex;align-items:center;gap:14px;cursor:default}
        ...
        .dd-card{background:#fff;border-radius:14px;border:1px solid #fef3c7;overflow:hidden}
        ...
        @media(max-width:900px){.dg-sb{display:none}.dg-main{margin-left:0}}
      `}</style>

      <div className="dg-wrap">
        <aside className="dg-sb">
